  ...
  questionResults: [
    {
      ...
      userAnswer: '트랜잭션을 롤백하고 예외를 다시 던진다.',
      selectedChoiceId: 402,
      isCorrect: true,
      aiFeedback: null,
    },
    {
      ...
      userAnswer: '같은 객체 안에서 호출하면 새로운 트랜잭션이 만들어지지 않기 때문입니다.',
      isCorrect: false,
    ...
    },
    {
      ...
      userAnswer: '여러 저장소 작업을 하나의 비즈니스 작업 단위로 묶어 일관성을 보장하기 위해서입니다.',
      isCorrect: true,
      aiFeedback: null,
    },
  ],
